...
import * as style from './centers-of-excellence-card.module.scss'
import classNames from 'classnames';
import { Link, navigate } from 'gatsby';


function CentersOfExcellenceCard({data}) {
  return (
    <div className={classNames(style.cardWrapper)}>
       <div className={style.innerWrapper} onClick={()=>{navigate('/centers-of-excellence/'+data.slug)}}>
        <div className={classNames(style.icon, !data.title && style.fullWidth)}>
          ...
          <Link to={'/centers-of-excellence/'+data.slug}>
            Know More 
...
export default CentersOfExcellenceCard