...
function OTPVerification() {
    ...
    return (
        <>
            {formData.isAlreadyRegistered === 'No' &&
                <div className='bg-primary rounded-5 text-white mb-5 p-5'>
                    <span>Patient Name</span>
                    <h5 className='font-bold text-l'>Abdul Waseem</h5>
                </div>
            }
            <div className={classNames(style.PatientFormSecMain, style.PatientFormSubMain)}>
                ...
                <div className={classNames(style.PatientFormBtnSec, 'flex-wrap')}>
                    ...
                    {formData.isAlreadyRegistered === 'No' ? 
                        (
                        <button 
                            className='button light-green btn-fill' 
                        >
                            Pay Now <img src={NextArrowIcon} alt='Next'/>
                        </button>
                        ):(
                            <button 
                                className='button light-green btn-fill' 
                                onClick={()=>{
                                    updateFormData({...formData, formStep: "5"  })
                                }}
                            >
                                Next <img src={NextArrowIcon} alt='Next'/>
                            </button>
                        )
                    }
                    ...
                    <h5 className='w-[100%]'>Didnt get OTP?</h5>
